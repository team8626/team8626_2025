...
@Deprecated
public class CoralShooterRampUpL1Only extends CS_Command {
  ...
  public CoralShooterRampUpL1Only() {
    mortar = RobotContainer.mortar;

    desiredRpmLeft = Presets.CORAL_L1.RPMLeft;
    desiredRpmRight = Presets.CORAL_L1.RPMRight;

    addRequirements(mortar);
    this.setTAGString("CORALSHOOTER_RAMPUPL1ONLY");
  }
  ...
  public void initialize() {
    ...
    printf("RPM Left: %f, RPM Right: %f", desiredRpmLeft, desiredRpmRight);
