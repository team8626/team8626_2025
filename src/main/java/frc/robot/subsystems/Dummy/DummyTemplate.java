...
public class DummyTemplate extends CS_SubsystemBase {
    ...
    public void updateDashboard() {
        ...
        // --------------------------------------------------
        // m_P = Utils8626.updateFromSmartDashboard(newP, m_P, (value) -> somePIDController.setP(value));
        // m_I = Utils8626.updateFromSmartDashboard(newI, m_I, (value) -> somePIDController.setP(value));
