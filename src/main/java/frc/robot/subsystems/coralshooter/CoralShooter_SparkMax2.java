...
public class CoralShooter_SparkMax2 implements CoralShooterInterface, CS_InterfaceBase {
  ...
  public CoralShooter_SparkMax2() {
    ...
    // Launcher Motor
    launchServo = new Servo(CoralShooterConstants.servoPWM);
  }
