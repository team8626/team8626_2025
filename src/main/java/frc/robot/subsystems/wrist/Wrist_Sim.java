...
public class Wrist_Sim implements WristInterface, CS_InterfaceBase {
  ...
  SingleJointedArmSim armSim =
      new SingleJointedArmSim(
          ...
          Units.degreesToRadians(WristConstants.minAngle.in(Degrees)),
          Units.degreesToRadians(WristConstants.maxAngle.in(Degrees)),
          false,
          Units.degreesToRadians(WristConstants.restAngle.in(Degrees)),
          new double[0]);
